...
urlpatterns = [
    ...
    path('restaurants/<uuid:restaurant_uuid>/menu', views.restaurant_menu, name='restaurant-menu'),
    path('restaurants/<uuid:restaurant_uuid>/menucategory',views.restaurant_menu_category, name='restaurant-menucategory'),
    ...
    path('restaurants/<uuid:restaurant_uuid>/menu_categories/<str:category_menu_name>/items',views.menu_items_by_category,
    name='restaurant-menu-items-by-category'), 

    #9
    path("restaurants/<uuid:restaurant_uuid>/menu-items",views.restaurant_menu_detail),
